...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 1. SMART ROLE DETECTION: Auto-correct based on email text
      ...
      // 2. SAVE TO LOCAL STORAGE: This powers your useAuth hook
      localStorage.setItem('userRole', finalRole);

      // 3. SECURE ROUTING: Push to the correct dashboard
      if (finalRole === 'admin') {
        router.push('/admin'); 
    ...
    <div className="min-h-screen bg-[#F0F4F8] flex flex-col items-center justify-center p-4 font-sans overflow-hidden">
      ...
      >
        ...
        <div className="relative bg-white rounded-[2rem] shadow-2xl p-8 sm:p-10">
          ...
          {/* TOGGLE SWITCH (Admin / Staff / Guest) */}
