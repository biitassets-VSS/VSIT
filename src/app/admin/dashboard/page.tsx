  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-sm border p-8 text-center">
        <h1 className="text-4xl font-extrabold text-blue-600 mb-4">Admin Dashboard</h1>
        <p className="text-gray-600 mb-8 text-lg">Welcome to the Admin Control Panel. You have full access.</p>
