...
export default function StaffDashboard() {
  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      try {
        ...
        // Fetch user profile metrics securely
        ...
        // Fetch Asset Stats for this specific user
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* ✨ CLEAN WELCOME BANNER CARD (BELL ICON REMOVED) */}
      <div className="bg-white rounded-[24px] p-6 shadow-sm border border-gray-100/80 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
      ...
      {/* TRACKING TICKETS DATA DISPLAY LOG */}
      ...
      {/* ASSIGNED ASSET DETAILS SUMMARY */}
      <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-5 border-b border-gray-50 flex items-center gap-2">
