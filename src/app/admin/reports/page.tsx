                ...
                <tbody className="divide-y divide-gray-100">
                  {filteredAssets.map((a) => (
                    <tr key={a.id} className="text-sm">
                      <td className="p-4 font-bold text-gray-900">{a.name}<br/><span className="text-[10px] text-gray-400">{a.tagId}</span></td>
                      <td className="p-4 font-bold text-gray-600">{a.category}</td>
                      <td className="p-4"><span className="px-2 py-1 rounded bg-gray-100 font-bold text-xs">{a.status}</span></td>
                    </tr>
                  ))}
                </tbody>
              </table>
