...
// Helper to get initials for the colorful avatar (e.g., MacBook Pro -> MP)
...
// Helper for card gradient based on category (matching image styles)
const getAvatarGradient = (category: string) => {
  if (category === 'Laptop') return 'bg-gradient-to-br from-blue-400 to-blue-600'; // Blue like JD
  if (category === 'Mobile') return 'bg-gradient-to-br from-purple-400 to-purple-500'; // Purple like JS
  return 'bg-gradient-to-br from-pink-400 to-rose-500'; // Pink like SW
};
    ...
    <div className="min-h-screen bg-[#F8F9FA] pb-12 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg text-sm font-semibold transition-colors flex items-center gap-2 shadow-sm">
        ...
        {/* --- SEARCH & FILTER BAR (Matches Image exactly) --- */}
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button className="bg-white border border-gray-200 text-gray-700 px-4 py-2.5 rounded-xl text-sm font-medium flex items-center justify-between min-w-[160px] hover:bg-gray-50 transition-colors">
            All Categories <ChevronDown size={16} className="text-gray-400" />
          </button>
        </div>

        {/* --- ASSETS GRID (Matches Image Cards exactly) --- */}
          ...
          {filteredAssets.map((asset) => {
            ...
            return (
              ...
              >
                ...
                {/* Grey Stats Box (Matches "Assigned Assets" box) */}
                ...
                {/* Bottom Buttons (Matches Deactivate/Delete style) */}
                <div className="flex gap-3 mt-4">
                  <button 
                    ...
                    className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-colors ${
                      ...
                      : 'bg-[#F0FDF4] text-[#16A34A] hover:bg-green-100' // Light Green tint
                    }`}
                  >
      ...
      {/* Kept identical functional logic, updated colors slightly for cohesion */}
      <AnimatePresence>
              ...
              <div className="p-6 overflow-y-auto flex-1 space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input 
                        ...
                        className={`w-full p-2.5 border rounded-lg bg-white outline-none text-sm ${isVerified ? 'border-green-300' : 'border-gray-200 focus:border-blue-500'}`}
                        value={verifyTag} 
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full p-3 border border-gray-200 rounded-xl h-24 resize-none bg-white outline-none focus:border-blue-500 text-sm"
                    value={notes}
